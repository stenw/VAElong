...
class TestVAETrainer(unittest.TestCase):
    ...
    def test_train_with_em_imputation_latent(self):
        """Test training with latent-space EM imputation."""
        data = generate_synthetic_longitudinal_data(
            n_samples=30,
            seq_len=12,
            n_features=self.input_dim,
    ...
    def test_train_with_em_imputation_rwmh(self):
        """Test training with missing-value RWMH EM imputation."""
        data = generate_synthetic_longitudinal_data(
            n_samples=30,
            seq_len=12,
            n_features=self.input_dim,
    ...
    def test_train_with_removed_direct_imputation_raises(self):
        ...
        with self.assertRaisesRegex(ValueError, "imputation_method must be 'rwmh' or 'latent'"):
