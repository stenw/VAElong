...
subtitle: "VAE Sampler Comparison vs RNN vs Ordinary Mixed Model Across Replications"
format:
  html:
    code-fold: false
    toc: true
...
- a longitudinal VAE trained with **Algorithm 1 latent-space updates**
...
- `examples/rwmh_missing_data_replications_files/replication_hyperparameters.csv`
...
hyperparameter_df = pd.read_csv(results_dir / "replication_hyperparameters.csv")
