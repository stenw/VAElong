...
def main():
    ...
    for idx in val_indices_list:
        ...
        tpcnn_all_predicted.append(
            dataset.inverse_transform(pred_i).detach())

    tpcnn_all_predicted = torch.cat(tpcnn_all_predicted, dim=0).numpy()

    # ---- 12. Transformer VAE benchmark ----
    print("\n--- Transformer VAE benchmark ---")
